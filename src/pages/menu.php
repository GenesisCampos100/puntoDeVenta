...
<nav id="sidebar" 
  ...
  <div>
    ...
    // Mapa de traducción de módulos
    $modulosTrad = [
        'nueva venta' => __('nueva_venta'),
        'ventas' => __('ventas'),
        'productos' => __('productos'),
        'proveedores' => __('proveedores'),
        'caja' => __('caja'),
        'reportes' => __('reportes'),
        'clientes' => __('clientes'),
        'empleados' => __('empleados')
    ];
    ?>
