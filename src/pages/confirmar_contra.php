...
<head>
    ...
    <title><?php echo __('confirm_new_password_title'); ?></title>
...
<body class="fondo_login">
    ...
    <main class="contenedor">
        ...
        <section class="contenedor-login">
            ...
            <div class="formulario">
                ...
                <h2><?php echo __('enter_new_password'); ?></h2>
                ...
                <form action="../scripts/process_reset.php" method="POST" id="reset-form">
                    <div class="contenedor-campos">
                        ...
                        <button class="boton" type="submit"><?php echo __('change_password_button'); ?></button>
                    </div>
                </form>
    ...
    <div id="successModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <p id="successMessage" class="modal-message"><?php echo __('password_change_success'); ?></p>
        </div>
    </div>
