...
<div class="max-w-7xl mx-auto p-4 md:p-6 pb-32">
    ...
    <div class="mb-8 animate-slideDown">
        <div class="mb-6">
            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2"><?php echo __('inventory_management'); ?></h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-2xl p-5 shadow-lg hover-lift animate-slideUp border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-sm font-medium mb-1"><?php echo __('total_products'); ?></p>
        ...
        <div class="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
            ...
            <div class="flex flex-wrap md:flex-nowrap gap-3 justify-end">
                ...
                <button id="btnAgregarProducto" onclick="window.location.href='index.php?view=agregar_producto'" class="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200" style="background: linear-gradient(135deg, #2d4353 0%, #1e2d38 100%);">
                    ...
                    <span class="hidden sm:inline"><?php echo __('add'); ?></span>
                </button>
            </div>
        </div>
    </div>
...
<div id="modalDetalle" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50">
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 overflow-hidden animate-scaleIn">
        ...
        <div class="px-6 py-4 border-b flex items-center justify-between header-dark" style="background: linear-gradient(135deg, #2d4353 0%, #1e2d38 100%);">
        ...
        <!-- Modal Header Image -->
        <div class="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 group overflow-hidden img-dark">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 text-white img-dark-text">
        ...
        <div class="p-6 space-y-6 section-dark">
            <!-- Price Section -->
            <div class="flex justify-between items-end border-b-2 border-gray-100 pb-6">
                <div>
                    <p class="text-xs text-gray-500 uppercase tracking-wider font-bold mb-2"><?php echo __('sale_price'); ?></p>
                    <p class="text-4xl font-bold tracking-tight" style="color: #b4c24d;">$<span id="modal-precio"></span></p>
                </div>
                <div class="text-right">
                    <p class="text-xs text-gray-500 uppercase tracking-wider font-bold mb-2"><?php echo __('cost'); ?></p>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100/50 p-5 rounded-xl border border-blue-200/50 hover:border-blue-300 transition-all card-dark">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <p class="text-xs text-gray-600 uppercase font-bold"><?php echo __('sku'); ?></p>
                    </div>
                    <p id="modal-codigo" class="font-mono text-gray-900 font-bold text-sm truncate"></p>
                </div>
                <div class="bg-gradient-to-br from-pink-50 to-pink-100/50 p-5 rounded-xl border border-pink-200/50 hover:border-pink-300 transition-all card-dark">
                    <div class="flex items-center gap-2 mb-3">
                        <svg class="w-5 h-5" style="color: #e15871;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                        </svg>
                        <p class="text-xs text-gray-600 uppercase font-bold"><?php echo __('stock_exists'); ?></p>
                    </div>
                    <div class="flex items-baseline gap-2">
                        <span id="modal-stock" class="text-2xl font-bold text-gray-900"></span>
                        <span class="text-xs text-gray-500 font-medium"><?php echo __('minimum_stock'); ?>: <span id="modal-stock-min"></span></span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                href="#"
                class="flex-1 py-4 rounded-xl font-bold text-center transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 text-white btn-editar-dark"
