...
$registro_success = $_SESSION['registro_success'] ?? '';
unset($_SESSION['registro_error'], $_SESSION['registro_success']);
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="fondo_login">
    ...
    <main class="contenedor">
        ...
        <section class="contenedor-login"> <!--Inicio de login-->
            ...
            <div class="registrate"> <!--Inicio formulario-->
                <div class="login-logo">
                    <img src="../imagenesDev/logo2.png" alt="logo">
                </div>
                <h1>Tu punto de venta favorito</h1>

                <?php if ($registro_error): ?>
                    <div class="alert alert-error"><?php echo htmlspecialchars($registro_error); ?></div>
                <?php endif; ?>

                <?php if ($registro_success): ?>
                    <div class="alert alert-success"><?php echo htmlspecialchars($registro_success); ?></div>
                <?php endif; ?>
                ...
                <form action="../scripts/register.php" method="post">
                    ...
                    <div class="contenedor-campos"> <!--Inicio contenedor de campos-->
                        ...
                        <input type="text" id="nombre_completo" name="nombre_completo" required placeholder="" value="<?php echo htmlspecialchars($old['nombre_completo'] ?? ''); ?>">
                        </div>
                        ...
                        <input type="email" id="email" name="email" required placeholder="" value="<?php echo htmlspecialchars($old['email'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="icon_right js-password-toggle">
                            <svg class="input-icon toggle-closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                            ...
                            <svg class="input-icon toggle-open" 
                    ...
                    <div class="campo">
                        ...
                        <input type="password" id="confirmar-password" name="password2" required placeholder="">
                ...
                <div class="login-navegacion_registrate"> <!--Inicio de navegación-->
                    <p>¿Tienes cuenta? <a href="/src/pages/login.php">Inicia sesión</a></p>
    ...
    <div id="successModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <p id="successMessage" class="modal-message">Registro exitoso. </p>
        </div>
    </div>
    ...
    <script src="../scripts/show_password.js"></script>
    <script src="../scripts/register_ajax.js"></script>
