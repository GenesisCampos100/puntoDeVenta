...
<div class="min-h-screen max-w-7xl mx-auto p-4 md:p-6 pb-32">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6 animate-slideUp">
        ...
        <div class="texto-cabierta flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-full border border-green-100 shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 animate-slideUp" style="animation-delay: 0.1s;">
        ...
        <div class="rounded-2xl shadow-lg p-6 text-white flex flex-col justify-between relative overflow-hidden" style="background: linear-gradient(135deg, #2d4353 0%, #1e2d38 100%);">
            ...
            <div class="grid grid-cols-2 gap-3 relative z-10">
                ...
                <button onclick="abrirModalCorte()" class="btn-rcortecaja col-span-2 p-3 rounded-xl flex items-center justify-center gap-2 font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-white" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);">
    ...
    <!-- Info Banner -->
    <div class="info-banner bg-white border border-blue-100 rounded-2xl p-5 shadow-md flex items-start gap-4 animate-slideUp" style="animation-delay: 0.2s;">
...
<div id="modalMovimiento" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/60 backdrop-blur-sm p-4 transition-opacity duration-300">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all scale-100 animate-fadeIn relative">
        ...
        <form id="formMovimiento" class="p-6 space-y-5">
            ...
            <button type="submit" class="save-btn w-full py-4 rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 mt-4 text-white" style="background: linear-gradient(135deg, #2d4353 0%, #1e2d38 100%);">
...
<div id="modalCorte" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/60 backdrop-blur-sm p-4 transition-opacity duration-300">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all scale-100 animate-fadeIn">
        ...
        <form id="formCorte" class="p-6 space-y-6">
            ...
            <button type="submit" class="finish-btn w-full py-4 rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 text-white" style="background: linear-gradient(135deg, #2d4353 0%, #1e2d38 100%);">
