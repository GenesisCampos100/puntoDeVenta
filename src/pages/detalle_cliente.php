...
<div class="max-w-7xl mx-auto">
  ...
  <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-4">
    ...
    <div class="flex gap-2">
      <a href="index.php?view=clientes" class="btn-volver px-4 py-2 rounded-lg border hover:bg-gray-50 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" /></svg>
        Volver
      </a>

      <button id="btnEliminar" class="btn-eliminar px-4 py-2 rounded-lg btn-danger hover:opacity-95 flex items-center gap-2">
