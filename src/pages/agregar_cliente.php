...
if (!empty($_SESSION['cliente_success'])) {
  $success = true;
  unset($_SESSION['cliente_success']);
}
...
<body>
  <div class="container">
    ...
    <!-- Main Form Card -->
    <form id="formCliente" method="POST" action="index.php?view=agregar_cliente" class="animate-in-delay-2">
...
cancelBtn.addEventListener('click', function(){
  ...
  Swal.fire({
    ...
    text: "Los cdatos ingresados se perderán",
    icon: 'warning',
