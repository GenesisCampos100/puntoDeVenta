    ...
    <div class="flex-1 flex flex-col overflow-hidden gap-4">
        ...
        <div class="flex gap-3 shrink-0">
            <div class="relative flex-1">
                ...
                <input id="quick-search" type="text" placeholder="<?php echo __('search_product_placeholder'); ?>" 
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="text-slate-500 text-xs uppercase tracking-wider font-semibold">
                            <th class="py-3 px-4 text-left w-[15%]"><?= __('code') ?></th>
                            <th class="py-3 px-4 text-left w-[30%]"><?= __('description') ?></th>
                            <th class="py-3 px-4 text-center w-[15%]"><?= __('price') ?></th>
                            <th class="py-3 px-4 text-center w-[15%]"><?= __('quantity_short') ?></th>
                            <th class="py-3 px-4 text-right w-[15%]"><?= __('total') ?></th>
    ...
    <div class="w-[340px] flex flex-col gap-4 shrink-0">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 card-shadow relative overflow-hidden group shrink-0">
            ...
            <div class="relative z-10">
                <label class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 block"><?= __('assigned_client') ?></label>
        ...
        <div class="flex-1 bg-slate-900 rounded-2xl p-5 text-white shadow-2xl flex flex-col justify-between relative overflow-hidden min-h-0">
            ...
            <div class="relative z-10 space-y-3 overflow-y-auto custom-scrollbar pr-1">
                <div class="flex justify-between items-center text-slate-300">
                    <span class="text-base font-medium"><?php echo __('subtotal'); ?></span>
