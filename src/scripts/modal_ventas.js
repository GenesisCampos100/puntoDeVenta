...
(() => {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function openTicketModal(idVenta) {
      const modal = document.getElementById("ticket-modal");
      const iframe = document.getElementById("ticket-iframe");

      // Cargar el ticket dentro del iframe
      iframe.src = `../src/scripts/ticket.php?id_venta=${idVenta}`;
    ...
    document.getElementById("close-ticket-modal")?.addEventListener("click", () => {
      ...
      // Limpiar iframe para evitar ruidos visuales al volver a abrir
      iframe.src = "";
    });
            ...
            ventaDetalles.innerHTML = `
              <div class="space-y-4">
                ...
                <div class="flex gap-3 pt-4">
                  <button onclick="openTicketModal(${idVenta})"
